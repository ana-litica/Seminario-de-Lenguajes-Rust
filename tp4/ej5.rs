...
impl Plataforma{
    ...
    fn agregar_transaccion(&mut self, monto:f64,tipo:TipoTransaccion,dni:u64){
        let transaccion=Transaccion::new(Fecha::hoy(), tipo, monto, dni);
...
#[cfg(test)]
mod test{
    use crate::{tp3::ej3::Fecha, tp4::ej5::{Blockchain, Criptomoneda, MedioDeRetiro, Plataforma, TipoTransaccion, Transaccion, Usuario}};
    ...
    fn ingresar_dinero_test(){
        ...
        let transaccion=Transaccion::new(Fecha::hoy(),
