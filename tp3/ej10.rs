...
impl Biblioteca{
    ...
    pub fn agregar_libro(&mut self, libro:Libro,cantidad:u16){
        self.copias_libros.insert(libro.isbn, cantidad);
    }

    pub fn obtener_cantidad_copias(&self,libro:Libro)->u16{
        if let Some(cantidad)=self.copias_libros.get(&libro.isbn){
            *cantidad
        }else{
            panic!();
        }
    ...
    pub fn decrementar_disposicion(&mut self, libro:Libro){
    ...
    pub fn incrementar_disposicion(&mut self, libro:Libro){
        let libr:Option<&mut u16>=self.copias_libros.get_mut(&libro.isbn);
        match libr{
            Some(libr)=> *libr+=1,
            None=>panic!(),
    ...
    pub fn realizar_prestamo(&mut self, cliente:Cliente,libro:Libro,mut fecha:Fecha,cantidad_dias:u32)->bool{
        if self.contar_prestamos_cliente(cliente.clone())<5 && self.obtener_cantidad_copias(libro.clone())>=1 {
            fecha.sumar_dias(cantidad_dias);
            let nuevo_prestamo=Prestamo::new(libro.clone(),cliente,fecha,"en préstamo".to_string());
    ...
    pub fn buscar_prestamo(&self,libro:Libro,cliente:Cliente)->Prestamo{
        let mut indice=0;
        while indice<self.prestamos.len(){
            if self.prestamos[indice].cliente.clone().mismo_cliente(&cliente) && self.prestamos[indice].libro.clone().mismo_libro(&libro){
                return self.prestamos[indice].clone();
            }
            indice+=1;
        }
        panic!();
    ...
    pub fn devolver_libro(&mut self,libro:Libro,cliente:Cliente,fecha_actual:Fecha)->bool{
        let prestamo=self.buscar_prestamo(libro.clone(), cliente);
        let mut indice=0;
        let mut devuelto=false;
        let fecha_devolucion=Some(fecha_actual);
        while !devuelto && indice<self.prestamos.len(){
            if self.prestamos[indice].clone().mismo_prestamo(&prestamo){
                self.prestamos[indice].estado="devuelto".to_string();
                self.prestamos[indice].devolucion=fecha_devolucion.clone();
                self.incrementar_disposicion(libro.clone());
                devuelto=true;
            }
            indice+=1;
        }
...
mod test{
    ...
    fn obtener_cantidad_copias_test(){
        ...
        biblio.agregar_libro(libro3.clone(), 5);
        biblio.agregar_libro(libro4, 7);

        assert_eq!(biblio.obtener_cantidad_copias(libro3),5);
    }
    ...
    fn obtener_cantidad_copias_sin_libros_test(){
        ...
        biblio.obtener_cantidad_copias(libro);
    }
    ...
    fn decrementar_disposicion_test(){
        ...
        assert_eq!(biblio.clone().obtener_cantidad_copias(libro3.clone()),5);
        biblio.decrementar_disposicion(libro3.clone());
        assert_eq!(biblio.obtener_cantidad_copias(libro3.clone()),4);
    ...
    fn decrementar_disposicion_libro_inexistente_test(){
        ...
        biblio.decrementar_disposicion(libro3);
    }
    #[test]
    #[should_panic]
    fn decrementar_disposicion_libro_sin_disposicion_test(){
        ...
        biblio.agregar_libro(libro1, 3);
        biblio.agregar_libro(libro2.clone(), 0);
        biblio.agregar_libro(libro3, 7);

        biblio.decrementar_disposicion(libro2);
    }
    ...
    fn decrementar_disposicion_sin_libros_test(){
        let mut biblio=Biblioteca::new("Biblioteca Central La Plata".to_string(),"Calle 50 N° 742, La Plata".to_string());
        let libro=Libro::new("9788437604947".to_string(),"El principito".to_string(),"Antoine de Saint-Exupéry".to_string(),96,Genero::Infantil);
        biblio.decrementar_disposicion(libro);
    }
    #[test]
    fn incrementar_disposicion_test(){
        ...
        assert_eq!(biblio.clone().obtener_cantidad_copias(libro3.clone()),5);
        biblio.incrementar_disposicion(libro3.clone());
        assert_eq!(biblio.obtener_cantidad_copias(libro3.clone()),6);
    ...
    fn incrementar_disposicion_libro_inexistente_test(){
        ...
        biblio.incrementar_disposicion(libro3);
    }
    ...
    fn incrementar_disposicion_sin_libros_test(){
        let mut biblio=Biblioteca::new("Biblioteca Central La Plata".to_string(),"Calle 50 N° 742, La Plata".to_string());
        let libro=Libro::new("9788437604947".to_string(),"El principito".to_string(),"Antoine de Saint-Exupéry".to_string(),96,Genero::Infantil);
        biblio.incrementar_disposicion(libro);
    }
    ...
    fn contar_prestamos_cliente_test(){
       ...
       let mut biblio=Biblioteca::new("Biblioteca Central La Plata".to_string(),"Calle 50 N° 742, La Plata".to_string());
        biblio.agregar_libro(libro1.clone(), 3);
        biblio.agregar_libro(libro2.clone(), 5);
        biblio.agregar_libro(libro3.clone(), 7);

        let fecha=Fecha::new(30, 05,2026);
        biblio.realizar_prestamo(cliente1.clone(), libro1, fecha.clone(), 10);
        biblio.realizar_prestamo(cliente1.clone(), libro2.clone(), fecha.clone(), 10);
    ...
    fn realizar_prestamo_test(){
        ...
        let libro=Libro::new("9788437604947".to_string(),"El principito".to_string(),"Antoine de Saint-Exupéry".to_string(),96,Genero::Infantil);
        let mut biblio=Biblioteca::new("Biblioteca Central La Plata".to_string(),"Calle 50 N° 742, La Plata".to_string());
        biblio.agregar_libro(libro.clone(), 3);
    ...
    fn realizar_prestamo_cliente_con_mayor_a_cinco_prestamos_test(){
        ...
        biblio.agregar_libro(libro1.clone(), 3);
        biblio.agregar_libro(libro2.clone(), 5);
        biblio.agregar_libro(libro3.clone(), 6);
        biblio.agregar_libro(libro4.clone(), 8);
        biblio.agregar_libro(libro5.clone(), 2);
        biblio.agregar_libro(libro6.clone(), 5);

        biblio.realizar_prestamo(cliente.clone(), libro1, Fecha::new(25,05,2026), 10);
        biblio.realizar_prestamo(cliente.clone(), libro2, Fecha::new(26,05,2026), 10);
        biblio.realizar_prestamo(cliente.clone(), libro3, Fecha::new(26,05,2026), 10);
        biblio.realizar_prestamo(cliente.clone(), libro4, Fecha::new(27,05,2026), 10);
        biblio.realizar_prestamo(cliente.clone(), libro5, Fecha::new(28,05,2026), 10);
    ...
    fn realizar_prestamo_sin_copias_disponibles_test(){
        ...
        let mut biblio=Biblioteca::new("Biblioteca Central La Plata".to_string(),"Calle 50 N° 742, La Plata".to_string());
        biblio.agregar_libro(libro.clone(), 0);
    ...
    fn realizar_prestamo_libro_inexistente_test(){
        ...
        let mut biblio=Biblioteca::new("Biblioteca Central La Plata".to_string(),"Calle 50 N° 742, La Plata".to_string());
        let fecha=Fecha::new(30, 05,2026);
        biblio.realizar_prestamo(cliente, libro, fecha, 5);
    }
    ...
    fn proximos_a_vencer_test(){
        ...
        biblio.realizar_prestamo(cliente.clone(), libro1,Fecha::new(31,05,2026), 4);
        biblio.realizar_prestamo(cliente.clone(), libro2,Fecha::new(31,05,2026), 20);
        biblio.realizar_prestamo(cliente2.clone(), libro3,Fecha::new(31,05,2026), 5);
    ...
    fn proximos_a_vencer_todos_sin_vencer_test(){
        ...
        biblio.realizar_prestamo(cliente.clone(), libro1,Fecha::new(31,05,2026), 15);
        biblio.realizar_prestamo(cliente.clone(), libro2,Fecha::new(31,05,2026), 25);
        biblio.realizar_prestamo(cliente2.clone(), libro3,Fecha::new(31,05,2026), 30);
        biblio.realizar_prestamo(cliente2.clone(), libro4,Fecha::new(31,05,2026), 20);
    ...
    fn proximos_a_vencer_todos_por_vencer_test(){
        ...
        biblio.realizar_prestamo(cliente.clone(), libro1,Fecha::new(31,05,2026), 2);
        biblio.realizar_prestamo(cliente.clone(), libro2,Fecha::new(31,05,2026), 5);
        biblio.realizar_prestamo(cliente2.clone(), libro3,Fecha::new(31,05,2026), 3);
        biblio.realizar_prestamo(cliente2.clone(), libro4,Fecha::new(31,05,2026), 2);
    ...
    fn proximos_a_vencer_todos_vencidos_test(){
        ...
        biblio.realizar_prestamo(cliente.clone(), libro1,Fecha::new(12,05,2026), 2);
        biblio.realizar_prestamo(cliente.clone(), libro2,Fecha::new(03,05,2026), 5);
        biblio.realizar_prestamo(cliente2.clone(), libro3,Fecha::new(10,05,2026), 3);
        biblio.realizar_prestamo(cliente2.clone(), libro4,Fecha::new(3,05,2026), 2);
    ...
    fn prestamos_vencidos_test(){
        ...
        biblio.realizar_prestamo(cliente.clone(), libro1,Fecha::new(12,05,2026), 2); //vencido y no devuelto
        biblio.realizar_prestamo(cliente.clone(), libro2.clone(),Fecha::new(15,05,2026), 5); //devuelto
        biblio.realizar_prestamo(cliente2.clone(), libro3,Fecha::new(10,05,2026), 3); //vencido y no devuelto
        biblio.realizar_prestamo(cliente2.clone(), libro4,Fecha::new(29,05,2026), 20);//no vencido

        let fecha=Fecha::new(18,05,2026);
        biblio.devolver_libro(libro2.clone(), cliente, fecha);
    ...
    fn prestamos_vencidos_todos_devueltos_test(){
        ...
        biblio.realizar_prestamo(cliente.clone(), libro1.clone(),Fecha::new(12,05,2026), 2);
        biblio.realizar_prestamo(cliente.clone(), libro2.clone(),Fecha::new(03,05,2026), 5);

        let fecha=Fecha::new(18,05,2026);
        biblio.devolver_libro(libro1, cliente.clone(), fecha.clone());
    ...
    fn buscar_prestamo_test(){
       ...
       let mut biblio=Biblioteca::new("Biblioteca Central La Plata".to_string(),"Calle 50 N° 742, La Plata".to_string());
        ...
        assert!(biblio.buscar_prestamo(libro2, cliente).mismo_prestamo(&prestamo));
    }
    ...
    fn buscar_prestamo_inxistente_test(){
        ...
        biblio.realizar_prestamo(cliente.clone(), libro1,Fecha::new(12,05,2026), 2);
        biblio.realizar_prestamo(cliente2.clone(), libro2.clone(),Fecha::new(03,05,2026), 5);

        biblio.buscar_prestamo(libro3, cliente);
    }
    ...
    fn buscar_prestamo_sin_prestamos_test(){
        ...
        biblio.buscar_prestamo(libro, cliente);
    }
    ...
    fn devolver_libro_inexistente_test(){
        ...
        biblio.devolver_libro(libro2, cliente, fecha_actual);
    }
    ...
    fn devolver_libro_sin_prestamos_test(){
        ...
        biblio.devolver_libro(libro, cliente, fecha_actual);
    }
